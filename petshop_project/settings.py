...
SECRET_KEY = 'django-insecure-s!jhm=j5f8kt*$#@jxign+=9nnt02+-r2fe$sr%zly0fz95dzk'
...
MIDDLEWARE = [
    'django.middleware.security.SecurityMiddleware',
    # Adicione o CorsMiddleware NO TOPO
...
# Configuração da API (REST Framework)
REST_FRAMEWORK = {
...
# Para desenvolvimento, vamos permitir todas as origens
